...
1. Upload unziped contents of 'futurelytics-woocommerce.zip' installation package to the '/wp-content/plugins/' directory of your WordPress installation.
2. Activate the plugin through the 'Plugins' menu in WordPress

OR

1. Upload the plugin by going to 'Plugins' -> 'Add New' menu in WordPress admin then selecting 'Upload Plugin' and choosing 'futurelytics-woocommerce.zip'.
2. Activate the plugin through the 'Plugins' menu in WordPress